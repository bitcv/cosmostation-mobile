...
import wannabit.io.bitcv.dialog.Dialog_MoreWait;
...
import static wannabit.io.bitcv.base.BaseConstant.BNB_MSG_TYPE_HTLC;
import static wannabit.io.bitcv.base.BaseConstant.BNB_MSG_TYPE_HTLC_CLIAM;
import static wannabit.io.bitcv.base.BaseConstant.BNB_MSG_TYPE_HTLC_REFUND;
import static wannabit.io.bitcv.base.BaseConstant.CERTIK_MSG_TYPE_TRANSFER;
import static wannabit.io.bitcv.base.BaseConstant.COSMOS_MSG_TYPE_DELEGATE;
import static wannabit.io.bitcv.base.BaseConstant.COSMOS_MSG_TYPE_REDELEGATE2;
import static wannabit.io.bitcv.base.BaseConstant.COSMOS_MSG_TYPE_TRANSFER;
import static wannabit.io.bitcv.base.BaseConstant.COSMOS_MSG_TYPE_TRANSFER2;
import static wannabit.io.bitcv.base.BaseConstant.COSMOS_MSG_TYPE_TRANSFER3;
import static wannabit.io.bitcv.base.BaseConstant.COSMOS_MSG_TYPE_UNDELEGATE2;
import static wannabit.io.bitcv.base.BaseConstant.COSMOS_MSG_TYPE_VOTE;
import static wannabit.io.bitcv.base.BaseConstant.COSMOS_MSG_TYPE_WITHDRAW_DEL;
import static wannabit.io.bitcv.base.BaseConstant.COSMOS_MSG_TYPE_WITHDRAW_MIDIFY;
import static wannabit.io.bitcv.base.BaseConstant.COSMOS_MSG_TYPE_WITHDRAW_VAL;
import static wannabit.io.bitcv.base.BaseConstant.ERROR_CODE_BROADCAST;
import static wannabit.io.bitcv.base.BaseConstant.ERROR_CODE_UNKNOWN;
...
import static wannabit.io.bitcv.base.BaseConstant.IOV_MSG_TYPE_REGISTER_ACCOUNT;
import static wannabit.io.bitcv.base.BaseConstant.IOV_MSG_TYPE_REGISTER_DOMAIN;
...
import static wannabit.io.bitcv.base.BaseConstant.IOV_MSG_TYPE_REPLACE_ACCOUNT_RESOURCE;
import static wannabit.io.bitcv.base.BaseConstant.IRIS_MSG_TYPE_COMMISSION;
import static wannabit.io.bitcv.base.BaseConstant.IRIS_MSG_TYPE_DELEGATE;
import static wannabit.io.bitcv.base.BaseConstant.IRIS_MSG_TYPE_REDELEGATE;
import static wannabit.io.bitcv.base.BaseConstant.IRIS_MSG_TYPE_TRANSFER;
import static wannabit.io.bitcv.base.BaseConstant.IRIS_MSG_TYPE_UNDELEGATE;
import static wannabit.io.bitcv.base.BaseConstant.IRIS_MSG_TYPE_VOTE;
import static wannabit.io.bitcv.base.BaseConstant.IRIS_MSG_TYPE_WITHDRAW;
import static wannabit.io.bitcv.base.BaseConstant.IRIS_MSG_TYPE_WITHDRAW_ALL;
import static wannabit.io.bitcv.base.BaseConstant.IRIS_MSG_TYPE_WITHDRAW_MIDIFY;
import static wannabit.io.bitcv.base.BaseConstant.IS_SHOWLOG;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_BEP3_CLAM_SWAP;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_BEP3_CREATE_SWAP;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_BEP3_REFUND_SWAP;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_CLAIM_HAVEST;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_CREATE_CDP;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_DEPOSIT_CDP;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_DEPOSIT_HAVEST;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_DRAWDEBT_CDP;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_INCENTIVE_REWARD;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_POST_PRICE;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_REPAYDEBT_CDP;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_WITHDRAW_CDP;
import static wannabit.io.bitcv.base.BaseConstant.KAVA_MSG_TYPE_WITHDRAW_HAVEST;
import static wannabit.io.bitcv.base.BaseConstant.OK_MSG_TYPE_DEPOSIT;
import static wannabit.io.bitcv.base.BaseConstant.OK_MSG_TYPE_DIRECT_VOTE;
import static wannabit.io.bitcv.base.BaseConstant.OK_MSG_TYPE_MULTI_TRANSFER;
import static wannabit.io.bitcv.base.BaseConstant.OK_MSG_TYPE_TRANSFER;
import static wannabit.io.bitcv.base.BaseConstant.OK_MSG_TYPE_WITHDRAW;
import static wannabit.io.bitcv.base.BaseConstant.TOKEN_BNB;
import static wannabit.io.bitcv.network.res.ResBnbSwapInfo.BNB_STATUS_OPEN;
import static wannabit.io.bitcv.network.res.ResKavaSwapInfo.STATUS_EXPIRED;
    ...
    public void onClick(View v) {
        if (v.equals(mDismissBtn)) {
            ...
            if (mBaseChain.equals(COSMOS_MAIN)) {
                ...
                shareIntent.putExtra(Intent.EXTRA_TEXT, EXPLORER_BAC_MAIN + "tx/" + mResTxInfo.txhash);
            }
    ...
    private class TxDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            if (position == 0) {
                ...
                if (mBaseChain.equals(BNB_MAIN) || mBaseChain.equals(BNB_TEST)) {
                    ...
                    if (mResTxInfo.getMsgType(position - 1).equals(COSMOS_MSG_TYPE_TRANSFER2) ||
                        ...
                        || mResTxInfo.getMsgType(position-1).equals(BAC_MSG_TYPE_SEND)) {
                        return TYPE_TX_TRANSFER;
        ...
        private void onBindCommon(RecyclerView.ViewHolder viewHolder) {
            ...
            if (mBaseChain.equals(COSMOS_MAIN) || mBaseChain.equals(KAVA_MAIN) || mBaseChain.equals(KAVA_TEST) ||
                    ...
                    || mBaseChain.equals(SECRET_MAIN) || mBaseChain.equals(BAC_MAIN)) {
                ...
                {
                    holder.itemFee.setText(WDp.getDpAmount2(getBaseContext(), mResTxInfo.simpleFee(), BAC_TOKEN_DECIMAL, 6));
                }
                else {
            ...
            holder.itemBtnHashLink.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mBaseChain.equals(COSMOS_MAIN) || mBaseChain.equals(KAVA_MAIN) || mBaseChain.equals(BAND_MAIN) || mBaseChain.equals(OK_TEST) ||
                            mBaseChain.equals(IOV_MAIN) || mBaseChain.equals(KAVA_TEST) || mBaseChain.equals(CERTIK_MAIN)
        ...
        private void onBindTransfer(RecyclerView.ViewHolder viewHolder, int position) {
            ...
            if (mBaseChain.equals(COSMOS_MAIN) || mBaseChain.equals(KAVA_MAIN) || mBaseChain.equals(KAVA_TEST) ||
                    mBaseChain.equals(BAND_MAIN) || mBaseChain.equals(IOV_MAIN) || mBaseChain.equals(IOV_TEST) ||
                    mBaseChain.equals(OK_TEST) || mBaseChain.equals(CERTIK_MAIN) ||
                    mBaseChain.equals(CERTIK_TEST) || mBaseChain.equals(AKASH_MAIN) || mBaseChain.equals(SECRET_MAIN)
            || mBaseChain.equals(BAC_MAIN)) {
                ...
                if (msg.type.equals(COSMOS_MSG_TYPE_TRANSFER2) || msg.type.equals(OK_MSG_TYPE_TRANSFER)
                        || msg.type.equals(CERTIK_MSG_TYPE_TRANSFER) || msg.type.equals(BAC_MSG_TYPE_SEND))  {
        ...
        private void onBindMultiSend(RecyclerView.ViewHolder viewHolder, int position) {
            ...
            if (mBaseChain.equals(COSMOS_MAIN) || mBaseChain.equals(KAVA_MAIN) || mBaseChain.equals(KAVA_TEST) || mBaseChain.equals(BAND_MAIN) || mBaseChain.equals(IOV_MAIN) ||
                    mBaseChain.equals(OK_TEST) || mBaseChain.equals(CERTIK_MAIN) || mBaseChain.equals(CERTIK_TEST) || mBaseChain.equals(IOV_TEST) || mBaseChain.equals(AKASH_MAIN) || mBaseChain.equals(SECRET_MAIN)) {
                final Msg msg = mResTxInfo.getMsg(position - 1);
...
//                WLog.w("toValAdd " + toValAdd);
    ...
    private void onFetchTx(String hash) {
        ...
        if (mBaseChain.equals(COSMOS_MAIN)) {
            ...
            ApiClient.getBacChain(getBaseContext()).getSearchTx(hash).enqueue(new Callback<ResTxInfo>() {
                @Override
                public void onResponse(Call<ResTxInfo> call, Response<ResTxInfo> response) {
                    if (isFinishing()) return;
                    WLog.w("onFetchTx " + response.toString());
            ...
            ApiClient.getCertikChain(getBaseContext()).getSearchTx(hash).enqueue(new Callback<ResTxInfo>() {
                @Override
                public void onResponse(Call<ResTxInfo> call, Response<ResTxInfo> response) {
                    if (isFinishing()) return;
                    WLog.w("onFetchTx " + response.toString());
