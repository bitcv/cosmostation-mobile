...
import wannabit.io.bitcv.activities.chains.kava.DrawDebtActivity;
...
public class DrawDebtCdpStep2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static DrawDebtCdpStep2Fragment newInstance(Bundle bundle) {
        DrawDebtCdpStep2Fragment fragment = new DrawDebtCdpStep2Fragment();
