...
import static wannabit.io.bitcv.base.BaseConstant.TASK_GEN_TX_DELETE_ACCOUNT;

public class SimpleDeleteAccountTask extends CommonTask {
    ...
    public SimpleDeleteAccountTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String domain, String name, String memo, Fee fee) {
        super(app, listener);
        ...
        this.mMemo = memo;
        this.mFees = fee;
        this.mResult.taskType = TASK_GEN_TX_DELETE_ACCOUNT;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            Msg deleteAccountMsg = MsgGenerator.genAccountDelete(mDomain, mName, mAccount.address, mBaseChain);
            ArrayList<Msg> msgs= new ArrayList<>();
            msgs.add(deleteAccountMsg);
