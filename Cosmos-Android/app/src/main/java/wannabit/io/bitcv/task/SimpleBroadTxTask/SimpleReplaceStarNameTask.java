...
import static wannabit.io.bitcv.base.BaseConstant.TASK_GEN_TX_REPLACE_STARNAME;

public class SimpleReplaceStarNameTask extends CommonTask {
    ...
    public SimpleReplaceStarNameTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String domain,
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            Msg replaceStarNameMsg = MsgGenerator.genReplaceStarName(mDomain, mName, mAccount.address, mResources, mBaseChain);
            ArrayList<Msg> msgs= new ArrayList<>();
            msgs.add(replaceStarNameMsg);
