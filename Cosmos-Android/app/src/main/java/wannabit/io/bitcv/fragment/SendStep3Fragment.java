...
import static wannabit.io.bitcv.base.BaseConstant.FEE_CERTIK_GAS_AMOUNT_SEND;
...
import static wannabit.io.bitcv.base.BaseConstant.FEE_IOV_GAS_AMOUNT_SEND;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IOV_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IRIS_GAS_AMOUNT_SEND;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IRIS_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_KAVA_GAS_AMOUNT_SEND;
    ...
    public void onClick(View v) {
        if(v.equals(mBeforeBtn)) {
            ...
            if (getSActivity().mBaseChain.equals(COSMOS_MAIN)) {
                ...
                Fee fee = new Fee();
                Coin gasCoin = new Coin();
                gasCoin.denom = BAC_MAIN_DENOM;
                gasCoin.amount = mFeeAmount.toPlainString();
                ArrayList<Coin> amount = new ArrayList<>();
                amount.add(gasCoin);
                fee.amount = amount;
                fee.gas = new BigDecimal(GAS_FEE_BAC_SEND).movePointRight(BAC_TOKEN_DECIMAL).toString();
                getSActivity().mTargetFee = fee;
