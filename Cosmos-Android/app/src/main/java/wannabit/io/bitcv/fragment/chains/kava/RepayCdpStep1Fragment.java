...
public class RepayCdpStep1Fragment extends BaseFragment implements View.OnClickListener {

    private EditText mMemo;
    private TextView mMemoCnt;
    private Button mBeforeBtn, mNextBtn;

    public static RepayCdpStep1Fragment newInstance(Bundle bundle) {
        RepayCdpStep1Fragment fragment = new RepayCdpStep1Fragment();
