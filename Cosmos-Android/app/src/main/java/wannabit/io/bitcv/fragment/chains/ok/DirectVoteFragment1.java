...
public class DirectVoteFragment1 extends BaseFragment implements View.OnClickListener {

    private EditText mMemo;
    private TextView mMemoCnt;
    private Button mBeforeBtn, mNextBtn;

    public static DirectVoteFragment1 newInstance(Bundle bundle) {
        DirectVoteFragment1 fragment = new DirectVoteFragment1();
