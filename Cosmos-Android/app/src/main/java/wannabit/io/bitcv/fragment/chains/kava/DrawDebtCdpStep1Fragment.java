...
public class DrawDebtCdpStep1Fragment extends BaseFragment implements View.OnClickListener {

    private EditText mMemo;
    private TextView mMemoCnt;
    private Button mBeforeBtn, mNextBtn;

    public static DrawDebtCdpStep1Fragment newInstance(Bundle bundle) {
        DrawDebtCdpStep1Fragment fragment = new DrawDebtCdpStep1Fragment();
