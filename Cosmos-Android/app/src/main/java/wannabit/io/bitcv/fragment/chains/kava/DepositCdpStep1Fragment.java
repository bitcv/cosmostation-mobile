...
public class DepositCdpStep1Fragment extends BaseFragment implements View.OnClickListener {

    private EditText mMemo;
    private TextView mMemoCnt;
    private Button mBeforeBtn, mNextBtn;

    public static DepositCdpStep1Fragment newInstance(Bundle bundle) {
        DepositCdpStep1Fragment fragment = new DepositCdpStep1Fragment();
