...
import wannabit.io.bitcv.activities.VoteActivity;
...
import static wannabit.io.bitcv.base.BaseConstant.FEE_AKASH_GAS_AMOUNT_VOTE;
...
import static wannabit.io.bitcv.base.BaseConstant.FEE_CERTIK_GAS_VOTE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_GAS_AMOUNT_HALF;
...
import static wannabit.io.bitcv.base.BaseConstant.SECRET_GAS_AMOUNT_VOTE;
...
public class VoteStep2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getSActivity().mBaseChain.equals(BaseChain.COSMOS_MAIN)) {
            ...
            mGasAmount.setText(FEE_CERTIK_GAS_VOTE);
            mGasRate.setText(WDp.getDpString(FEE_CERTIK_GAS_RATE_AVERAGE, 3));
            mFeeAmount = new BigDecimal(FEE_CERTIK_GAS_VOTE).multiply(new BigDecimal(FEE_CERTIK_GAS_RATE_AVERAGE)).setScale(0);
            ...
            mGasAmount.setText(SECRET_GAS_AMOUNT_VOTE);
            mGasRate.setText(WDp.getDpString(SECRET_GAS_FEE_RATE_AVERAGE, 3));
            mFeeAmount = new BigDecimal(SECRET_GAS_AMOUNT_VOTE).multiply(new BigDecimal(SECRET_GAS_FEE_RATE_AVERAGE)).setScale(0);
    ...
    public void onClick(View v) {
        if(v.equals(mBeforeBtn)) {
            ...
            if (getSActivity().mBaseChain.equals(BaseChain.COSMOS_MAIN)) {
                ...
                amount.add(gasCoin);
                fee.amount = amount;
                fee.gas = SECRET_GAS_AMOUNT_VOTE;
                getSActivity().mFee = fee;
