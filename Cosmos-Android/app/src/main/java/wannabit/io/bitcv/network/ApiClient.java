...
public class ApiClient {
    ...
    private static BacChain service_api_bac_main = null;
    ...
    public static BacChain getBacChainApi(Context c) {
        if (service_api_bac_main == null) {
            synchronized (ApiClient.class) {
                Retrofit retrofit = new Retrofit.Builder()
                        .baseUrl(c.getString(R.string.url_api_bac_main))
                        .addConverterFactory(GsonConverterFactory.create())
                        .build();
                service_api_bac_main = retrofit.create(BacChain.class);
            }
        }
        return service_api_bac_main;
    }
