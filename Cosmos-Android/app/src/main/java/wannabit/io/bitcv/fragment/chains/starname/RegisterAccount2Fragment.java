...
public class RegisterAccount2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static RegisterAccount2Fragment newInstance(Bundle bundle) {
        RegisterAccount2Fragment fragment = new RegisterAccount2Fragment();
