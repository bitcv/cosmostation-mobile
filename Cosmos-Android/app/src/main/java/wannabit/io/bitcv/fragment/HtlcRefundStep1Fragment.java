...
import wannabit.io.bitcv.activities.HtlcRefundActivity;
import wannabit.io.bitcv.R;
import wannabit.io.bitcv.base.BaseFragment;
import wannabit.io.bitcv.utils.WUtil;

public class HtlcRefundStep1Fragment extends BaseFragment implements View.OnClickListener {

    private EditText    mMemo;
    private TextView    mMemoCnt;
    private Button      mBeforeBtn, mNextBtn;

    public static HtlcRefundStep1Fragment newInstance(Bundle bundle) {
        HtlcRefundStep1Fragment fragment = new HtlcRefundStep1Fragment();
