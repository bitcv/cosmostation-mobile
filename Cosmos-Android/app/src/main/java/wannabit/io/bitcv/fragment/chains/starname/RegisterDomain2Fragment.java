...
import wannabit.io.bitcv.activities.chains.starname.RegisterStarNameDomainActivity;
...
public class RegisterDomain2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static RegisterDomain2Fragment newInstance(Bundle bundle) {
        RegisterDomain2Fragment fragment = new RegisterDomain2Fragment();
