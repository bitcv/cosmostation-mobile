...
import wannabit.io.bitcv.fragment.chains.kava.DepositHarvestStep0Fragment;
import wannabit.io.bitcv.fragment.chains.kava.DepositHarvestStep1Fragment;
import wannabit.io.bitcv.fragment.chains.kava.DepositHarvestStep2Fragment;
import wannabit.io.bitcv.fragment.chains.kava.DepositHarvestStep3Fragment;
...
public class DepositHarvestActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle.setText(getString(R.string.str_deposit_harvest));
        ...
        mTvStep.setText(getString(R.string.str_deposit_harvest_step_1));
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if(i == 0) {
                    ...
                    mTvStep.setText(getString(R.string.str_deposit_harvest_step_2));
                } else if (i == 2 ) {
                    mIvStep.setImageDrawable(getDrawable(R.drawable.step_4_img_3));
                    mTvStep.setText(getString(R.string.str_deposit_harvest_step_3));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                } else if (i == 3 ) {
                    mIvStep.setImageDrawable(getDrawable(R.drawable.step_4_img_4));
                    mTvStep.setText(getString(R.string.str_deposit_harvest_step_4));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                }
            }
