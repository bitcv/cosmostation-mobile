...
import wannabit.io.bitcv.dialog.Dialog_Fee_Description;
...
import static wannabit.io.bitcv.base.BaseConstant.FEE_AKASH_GAS_AMOUNT_REDELEGATE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_AKASH_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_CERTIK_GAS_AMOUNT_REDELEGATE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_CERTIK_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_GAS_AMOUNT_REDELEGATE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IOV_GAS_AMOUNT_REDELEGATE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IOV_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IRIS_GAS_AMOUNT_REDELEGATE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IRIS_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_KAVA_GAS_AMOUNT_REDELEGATE;
import static wannabit.io.bitcv.base.BaseConstant.SECRET_GAS_AMOUNT_REDELEGATE;
...
public class RedelegateStep3Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getSActivity().mBaseChain.equals(COSMOS_MAIN)) {
            ...
            mGasAmount.setText(FEE_IRIS_GAS_AMOUNT_REDELEGATE);
            mGasRate.setText(WDp.getDpString(FEE_IRIS_GAS_RATE_AVERAGE, 6));
            mFeeAmount = new BigDecimal(FEE_IRIS_GAS_AMOUNT_REDELEGATE).multiply(new BigDecimal(FEE_IRIS_GAS_RATE_AVERAGE)).movePointRight(18).setScale(0);
            ...
            mGasFeeAmount.setText(WDp.getDpString(WDp.attoToIris(mFeeAmount).setScale(1, RoundingMode.DOWN).toPlainString(), 2));
            ...
            mGasAmount.setText(FEE_AKASH_GAS_AMOUNT_REDELEGATE);
            mGasRate.setText(WDp.getDpString(FEE_AKASH_GAS_RATE_AVERAGE, 3));
            mFeeAmount = new BigDecimal(FEE_AKASH_GAS_AMOUNT_REDELEGATE).multiply(new BigDecimal(FEE_AKASH_GAS_RATE_AVERAGE)).setScale(0);
            if(getBaseDao().getCurrency() != 5) {
    ...
    public void onClick(View v) {
        if(v.equals(mBeforeBtn)) {
            ...
            if (getSActivity().mBaseChain.equals(COSMOS_MAIN)) {
                ...
                amount.add(gasCoin);
                fee.amount = amount;
                fee.gas = FEE_IRIS_GAS_AMOUNT_REDELEGATE;
                getSActivity().mReDelegateFee = fee;
