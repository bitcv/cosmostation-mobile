...
public class DeleteStarName1Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static DeleteStarName1Fragment newInstance(Bundle bundle) {
        DeleteStarName1Fragment fragment = new DeleteStarName1Fragment();
