...
//        result.add(CERTIK_TEST);
    ...
    public static ArrayList<String>  getHtlcSwappableCoin(BaseChain fromChain) {
        ...
        if (fromChain.equals(BNB_MAIN)) {
            result.add(BaseConstant.TOKEN_HTLC_BINANCE_BNB);
            result.add(BaseConstant.TOKEN_HTLC_BINANCE_BTCB);
            result.add(BaseConstant.TOKEN_HTLC_BINANCE_XRPB);
            result.add(BaseConstant.TOKEN_HTLC_BINANCE_BUSD);

        } else if (fromChain.equals(KAVA_MAIN)) {
            result.add(BaseConstant.TOKEN_HTLC_KAVA_BNB);
            result.add(BaseConstant.TOKEN_HTLC_KAVA_BTCB);
            result.add(BaseConstant.TOKEN_HTLC_KAVA_XRPB);
            result.add(BaseConstant.TOKEN_HTLC_KAVA_BUSD);

        } else if (fromChain.equals(BNB_TEST)) {
            result.add(BaseConstant.TOKEN_HTLC_BINANCE_TEST_BNB);
            result.add(BaseConstant.TOKEN_HTLC_BINANCE_TEST_BTC);

        } else if (fromChain.equals(KAVA_TEST)) {
            result.add(BaseConstant.TOKEN_HTLC_KAVA_TEST_BNB);
            result.add(BaseConstant.TOKEN_HTLC_KAVA_TEST_BTC);
        }
        return result;
    }
}
