...
import static wannabit.io.bitcv.base.BaseConstant.FEE_IOV_GAS_AMOUNT_DELETE;
...
public class DeleteStarName2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static DeleteStarName2Fragment newInstance(Bundle bundle) {
        DeleteStarName2Fragment fragment = new DeleteStarName2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getSActivity().mBaseChain.equals(IOV_MAIN) || getSActivity().mBaseChain.equals(IOV_TEST)) {
            ...
            mFeeAmount = new BigDecimal(FEE_IOV_GAS_AMOUNT_DELETE).multiply(new BigDecimal(FEE_IOV_GAS_RATE_AVERAGE)).setScale(0);
    ...
    public void onClick(View v) {
        if(v.equals(mBeforeBtn)) {
            ...
            if (getSActivity().mBaseChain.equals(IOV_MAIN)) {
                ...
                amount.add(gasCoin);
                fee.amount = amount;
                fee.gas = FEE_IOV_GAS_AMOUNT_DELETE;
