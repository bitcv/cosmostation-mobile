...
import wannabit.io.bitcv.activities.chains.starname.RegisterStarNameAccountActivity;
...
import static wannabit.io.bitcv.base.BaseConstant.FEE_IOV_GAS_AMOUNT_REGISTER;
...
public class RegisterAccount3Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static RegisterAccount3Fragment newInstance(Bundle bundle) {
        RegisterAccount3Fragment fragment = new RegisterAccount3Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getSActivity().mBaseChain.equals(IOV_MAIN) || getSActivity().mBaseChain.equals(IOV_TEST)) {
            ...
            mFeeAmount = new BigDecimal(FEE_IOV_GAS_AMOUNT_REGISTER).multiply(new BigDecimal(FEE_IOV_GAS_RATE_AVERAGE)).setScale(0);
    ...
    public void onClick(View v) {
        if(v.equals(mBeforeBtn)) {
            ...
            if (getSActivity().mBaseChain.equals(IOV_MAIN)) {
                ...
                amount.add(gasCoin);
                fee.amount = amount;
                fee.gas = FEE_IOV_GAS_AMOUNT_REGISTER;
