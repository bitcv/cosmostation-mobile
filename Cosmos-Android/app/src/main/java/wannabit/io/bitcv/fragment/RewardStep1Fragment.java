...
public class RewardStep1Fragment extends BaseFragment implements View.OnClickListener {

    private EditText mMemo;
    private TextView mMemoCnt;
    private Button mBeforeBtn, mNextBtn;

    public static RewardStep1Fragment newInstance(Bundle bundle) {
        RewardStep1Fragment fragment = new RewardStep1Fragment();
