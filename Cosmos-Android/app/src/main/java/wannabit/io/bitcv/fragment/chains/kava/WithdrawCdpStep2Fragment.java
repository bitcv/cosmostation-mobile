...
import wannabit.io.bitcv.activities.chains.kava.WithdrawCdpActivity;
...
public class WithdrawCdpStep2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static WithdrawCdpStep2Fragment newInstance(Bundle bundle) {
        WithdrawCdpStep2Fragment fragment = new WithdrawCdpStep2Fragment();
