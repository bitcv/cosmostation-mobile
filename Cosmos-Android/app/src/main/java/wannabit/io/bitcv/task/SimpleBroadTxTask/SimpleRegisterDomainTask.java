...
import static wannabit.io.bitcv.base.BaseConstant.TASK_GEN_TX_REGISTER_DOMAIN;

public class SimpleRegisterDomainTask extends CommonTask {
    ...
    public SimpleRegisterDomainTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String domain, String domainType, String memo, Fee fees) {
        super(app, listener);
        ...
        this.mMemo = memo;
        this.mFees = fees;
        this.mResult.taskType = TASK_GEN_TX_REGISTER_DOMAIN;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            Msg registerDomainMsg = MsgGenerator.genDomainRegister(mDomain, mAccount.address, mDomainType, mBaseChain);
            ArrayList<Msg> msgs= new ArrayList<>();
            msgs.add(registerDomainMsg);
