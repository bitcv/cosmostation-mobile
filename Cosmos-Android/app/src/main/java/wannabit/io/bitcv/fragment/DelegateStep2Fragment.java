...
import static wannabit.io.bitcv.base.BaseConstant.FEE_AKASH_GAS_AMOUNT_STAKE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_AKASH_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_CERTIK_GAS_AMOUNT_STAKE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_CERTIK_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_GAS_AMOUNT_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_GAS_RATE_LOW;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IOV_GAS_AMOUNT_STAKE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IOV_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IRIS_GAS_AMOUNT_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_IRIS_GAS_RATE_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.FEE_KAVA_GAS_AMOUNT_AVERAGE;
import static wannabit.io.bitcv.base.BaseConstant.SECRET_GAS_AMOUNT_STAKE;
...
public class DelegateStep2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    private BigDecimal      mToDelegate     = BigDecimal.ZERO;      // uatom scale
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getSActivity().mBaseChain.equals(COSMOS_MAIN)) {
            ...
            mFeeAmount = new BigDecimal(FEE_IRIS_GAS_AMOUNT_AVERAGE).multiply(new BigDecimal(FEE_IRIS_GAS_RATE_AVERAGE)).movePointRight(18).setScale(0);
            ...
            mGasAmount.setText(FEE_AKASH_GAS_AMOUNT_STAKE);
            mGasRate.setText(WDp.getDpString(FEE_AKASH_GAS_RATE_AVERAGE, 3));
            mFeeAmount = new BigDecimal(FEE_AKASH_GAS_AMOUNT_STAKE).multiply(new BigDecimal(FEE_AKASH_GAS_RATE_AVERAGE)).setScale(0);
            if(getBaseDao().getCurrency() != 5) {
    ...
    public void onClick(View v) {
        if(v.equals(mBeforeBtn)) {
            ...
            if (getSActivity().mBaseChain.equals(COSMOS_MAIN)) {
                ...
                amount.add(gasCoin);
                fee.amount = amount;
                fee.gas = FEE_AKASH_GAS_AMOUNT_STAKE;
                getSActivity().mToDelegateFee = fee;
