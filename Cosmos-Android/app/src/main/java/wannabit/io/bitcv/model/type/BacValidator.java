...
import wannabit.io.bitcv.network.res.ResKeyBaseUser;

public class BacValidator implements Parcelable {
    ...
    public BacValidator(String operator_address, String consensus_pubkey, Boolean jailed, String tokens, int status,
    ...
    protected BacValidator(Parcel in) {
        readFromParcel(in);
    }
    ...
    public static final Creator<BacValidator> CREATOR = new Creator<BacValidator>() {
        @Override
        public BacValidator createFromParcel(Parcel in) {
            return new BacValidator(in);
        }

        @Override
        public BacValidator[] newArray(int size) {
            return new BacValidator[size];
        }
    };
...
//    }
    ...
    public boolean equals(Object object)
    {
        ...
        if (object != null && object instanceof BacValidator) {
            sameSame = this.description.moniker.equals(((BacValidator)object).description.moniker);
        }
