...
public class RegisterDomain1Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static RegisterDomain1Fragment newInstance(Bundle bundle) {
        RegisterDomain1Fragment fragment = new RegisterDomain1Fragment();
