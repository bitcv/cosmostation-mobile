...
import static wannabit.io.bitcv.base.BaseConstant.FEE_IOV_GAS_AMOUNT_REPLACE;
...
public class ReplaceStarName2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static ReplaceStarName2Fragment newInstance(Bundle bundle) {
        ReplaceStarName2Fragment fragment = new ReplaceStarName2Fragment();
