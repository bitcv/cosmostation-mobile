...
public class RenewStarName1Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static RenewStarName1Fragment newInstance(Bundle bundle) {
        RenewStarName1Fragment fragment = new RenewStarName1Fragment();
