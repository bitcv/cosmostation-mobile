...
import wannabit.io.bitcv.activities.chains.kava.DepositCdpActivity;
...
public class DepositCdpStep2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static DepositCdpStep2Fragment newInstance(Bundle bundle) {
        DepositCdpStep2Fragment fragment = new DepositCdpStep2Fragment();
