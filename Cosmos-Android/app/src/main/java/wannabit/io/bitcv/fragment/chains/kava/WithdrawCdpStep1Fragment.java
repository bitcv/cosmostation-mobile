...
public class WithdrawCdpStep1Fragment extends BaseFragment implements View.OnClickListener {

    private EditText mMemo;
    private TextView mMemoCnt;
    private Button mBeforeBtn, mNextBtn;

    public static WithdrawCdpStep1Fragment newInstance(Bundle bundle) {
        WithdrawCdpStep1Fragment fragment = new WithdrawCdpStep1Fragment();
