...
public class ReInvestStep1Fragment extends BaseFragment implements View.OnClickListener {

    private EditText mMemo;
    private TextView mMemoCnt;
    private Button mBeforeBtn, mNextBtn;

    public static ReInvestStep1Fragment newInstance(Bundle bundle) {
        ReInvestStep1Fragment fragment = new ReInvestStep1Fragment();
