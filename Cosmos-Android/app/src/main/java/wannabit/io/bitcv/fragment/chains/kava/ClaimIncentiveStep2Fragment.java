...
import wannabit.io.bitcv.activities.chains.kava.ClaimIncentiveActivity;
...
public class ClaimIncentiveStep2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static ClaimIncentiveStep2Fragment newInstance(Bundle bundle) {
        ClaimIncentiveStep2Fragment fragment = new ClaimIncentiveStep2Fragment();
